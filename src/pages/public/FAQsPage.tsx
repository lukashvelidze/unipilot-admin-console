...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'You can reach our support team through the contact form on our website or by emailing unipilot@unipilot.app. Premium users have access to priority support with faster response times.',
  },
  {
    ...
    <div className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 text-center">
          ...
          <a
            href="mailto:unipilot@unipilot.app"
